...
import alatoo.car_booking.dtos.AuthenticationRequest;
import alatoo.car_booking.dtos.AuthenticationResponse;
...
import alatoo.car_booking.services.jwt.UserService;
import alatoo.car_booking.utils.JwtUtil;
...
public class AuthController {
    ...
    public ResponseEntity<?> createCustomer(@RequestBody SignupRequest signupRequest) {
        if(authService.hasCustomerWithEmail(signupRequest.getEmail())) {
            return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE).body("Email already in use. Try again.");
        }
